...
(@miss32, 'Inspeção de Navio Ancorado',        'Aberta',    'Alto',   'Averiguar distorções temporais',    '2025-05-24 02:30:00', NULL,         @addr53, @hq2),
(@miss33, 'Reconhecimento em Zona Rural',      'Aberta',    'Médio',  'Catalogar fenômenos discretos',     '2025-05-27 08:00:00', NULL,         @addr54, @hq2),
...
-- QG 3
(@miss39,  'Investigação em Fábrica Abandonada',   'Aberta',    'Alto',   'Examinar fenômenos',             '2025-05-08 14:00:00', NULL,         @addr7,  @hq3),
(@miss40,  'Proteção de Local Histórico',          'Aberta',    'Médio',  'Garantir segurança',             '2025-05-15 09:00:00', NULL,         @addr8,  @hq3),
...
(@miss49, 'Exploração de Estrutura Antiga',    'Aberta',    'Médio',  'Mapear traços arcanos',             '2025-05-24 16:00:00', NULL,         @addr63, @hq3),
(@miss50, 'Proteção em Escola Técnica',        'Aberta',    'Alto',   'Neutralizar influência nefasta',    '2025-05-26 08:00:00', NULL,         @addr64, @hq3),
...
-- QG 4
(@miss56, 'Proteção de Arranha-céu',              'Aberta',    'Alto',   'Evitar invasões espectrais',     '2025-05-12 23:00:00', NULL,         @addr15, @hq4),
(@miss57, 'Ronda Cultural Urbana',                'Concluida', 'Baixo',  'Inspeção em teatros antigos',    '2025-02-28 18:00:00', '2025-02-28', @addr16, @hq4),
(@miss58, 'Investigação em Túnel Subterrâneo',    'Aberta',    'Médio',  'Averiguar ruídos estranhos',     '2025-05-18 22:30:00', NULL,         @addr17, @hq4),
(@miss59, 'Vigilância de Torre Corporativa',      'Concluida', 'Baixo',  'Checar alarmes místicos',        '2025-03-10 20:00:00', '2025-03-11', @addr19, @hq4),
(@miss60, 'Patrulha em Favela Histórica',         'Concluida', 'Médio',  'Coletar relatos locais',         '2025-02-18 20:00:00', '2025-02-19', @addr32, @hq4),
...
(@miss69, 'Proteção de Prédio Governamental',  'Aberta',    'Alto',   'Evitar sabotagens espectrais',      '2025-05-24 08:30:00', NULL,         @addr73, @hq4),
(@miss70, 'Verificação de Espaço Cultural',    'Aberta',    'Médio',  'Identificar distorções no ar',      '2025-05-26 10:00:00', NULL,         @addr74, @hq4),
...
(@miss72, 'Patrulha em Terminal Rodoviário',   'Aberta',    'Médio',  'Prevenir influências hostis',       '2025-05-30 12:00:00', NULL,         @addr76, @hq4),
(@miss73, 'Observação de Ponto Turístico',     'Aberta',    'Baixo',  'Registrar fluxos energéticos',      '2025-06-01 09:30:00', NULL,         @addr77, @hq4),
...
-- QG 5
(@miss76, 'Monitoramento da Floresta',            'Aberta',    'Médio',  'Detectar sinais místicos',       '2025-05-02 07:00:00', NULL,         @addr13, @hq5),
(@miss77, 'Análise de Relíquias',                 'Concluida', 'Alto',   'Catalogar objetos sagrados',     '2025-03-20 09:00:00', '2025-04-01', @addr14, @hq5),
(@miss78, 'Expedição Fluvial',                    'Aberta',    'Médio',  'Explorar igarapés remotos',      '2025-04-18 06:00:00', NULL,         @addr27, @hq5),
(@miss79, 'Reconhecimento de Margem',             'Concluida', 'Baixo',  'Mapear cursos d’água',           '2025-03-05 07:00:00', '2025-03-07', @addr28, @hq5),
...
-- QG 6
(@miss90, 'Inspeção em Palacete Histórico',       'Concluida', 'Médio',  'Revisar integridade estrutural', '2025-02-20 10:00:00', '2025-02-21', @addr25, @hq6),
(@miss91, 'Monitoramento de Comunidade',          'Aberta',    'Baixo',  'Entrevistar moradores',        '2025-05-08 09:00:00', NULL,         @addr26, @hq6),
(@miss92, 'Inspeção no Canal de Esgoto Antigo',   'Aberta',    'Médio',  'Rastreamento de corrupção mística',     '2025-05-21 23:00:00', NULL,         @addr90, @hq6),
(@miss93, 'Ritual de Contenção no Subsolo',       'Aberta',    'Alto',   'Selar passagem dimensional instável',   '2025-05-22 01:00:00', NULL,         @addr91, @hq6),
(@miss94, 'Exploração de Tunelamento Urbano',     'Concluida', 'Médio',  'Analisar runas esquecidas',             '2025-04-08 04:00:00', '2025-04-09', @addr92, @hq6),
(@miss95, 'Vigilância em Centro de Reciclagem',   'Aberta',    'Baixo',  'Prevenir contaminação espiritual',      '2025-05-24 05:30:00', NULL,         @addr93, @hq6),
(@miss96, 'Monitoramento de Armazém Portuário',   'Aberta',    'Médio',  'Verificar fluxos arcanos ilegais',      '2025-05-26 02:00:00', NULL,         @addr94, @hq6),
(@miss97, 'Análise de Entulho Anômalo',           'Concluida', 'Médio',  'Catalogar resíduos mágicos',            '2025-04-01 03:00:00', '2025-04-02', @addr95, @hq6),
(@miss98, 'Ronda Secreta em Distrito Industrial', 'Aberta',    'Alto',   'Identificar entidades encobertas',      '2025-05-30 22:00:00', NULL,         @addr96, @hq6),
(@miss99, 'Supervisão de Interdição Ritualística','Aberta',    'Médio',  'Manter área protegida',                 '2025-06-02 04:30:00', NULL,         @addr97, @hq6),
(@miss100, 'Verificação de Correntes Etéreas',     'Aberta',    'Médio',  'Examinar presença de vórtices sutis',   '2025-06-03 03:00:00', NULL,         @addr99, @hq6);
